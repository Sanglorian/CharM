...
species, all 133 feats, all 20 prestige paths, all six epic paths, the six kits
(each wired to its discipline), and a starter set of weapons, armor and gear.
**All 24 disciplines and all 25 species in the source books are now transcribed.**
Remaining work: the rest of the kit roster (~25 source kits, 6 transcribed) —
which is also what makes the four kit-only disciplines (High Cunning, Third Mind,
Deep Dark Truthful Mirror) and Cantrips reachable in-app; the animal-companion
mechanics on Red in Tooth and Claw; and the rest of the equipment / magic-item
list. The
